...
| **Last verified** | 2026-08-25 — 328 tests pass, `./init.sh` green, `ingest_pdfs.py --verify` PASS with 0 failures across the whole corpus. **39 of 46 features passing; 6 blocked on other people, 1 (`ingest-003`) open and real.** |
