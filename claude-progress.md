...
| **Last verified** | 2026-08-25 — 337 tests pass, `./init.sh` green, `ingest_pdfs.py --verify` PASS with 0 failures across the whole corpus. **40 of 46 features passing; the other 6 are all blocked on other people, not on code.** |
